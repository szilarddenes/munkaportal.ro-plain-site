...
var JobAnnouncement = document.getElementById('JobAnnouncement');
...
function checkInputs() {
    ...
    //const JobAnnouncementValue = JobAnnouncement.strValue;
    ...
    // //findUS --has to be done
    // if (chkFacebook === 'yes') {
    //     //show error
    //     //add error class
    //     setSuccessFor(findUS);
    // } else {
    //     setErrorFor(findUS, `Please select one option.`);
    // }

    //deadline
    if (JobAnnouncementValue === 'empty') {
        //show error
        //add error class
        setErrorFor(JobAnnouncement, `Post the job details please.`);
    } else {
        setSuccessFor(JobAnnouncement);
    }
