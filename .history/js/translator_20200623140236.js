...
var translator = new Translator({
  ...
  translator.load();
  var baseElement= document.querySelectorAll("li");
  cons flagElement= baseElement.querySelector("a")''
  baseElement.querySelector("a").addEventListener('click', function (evt) {
