...
//   console.log(`kures`, karakterures);
  ...
  if (karakterures === '' || karakterhossz > 2000) {
    //show error
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        setErrorFor(jobAdiv, 'A megadott dátum helytelen.');
                                        break
                                    case "ro":
                                        setErrorFor(jobAdiv, 'Data este incorectă.');
                                        break
                                    case "en":
                                        setErrorFor(jobAdiv, 'The date is incorrect.');
                                        break
                                    case "de":
                                        setErrorFor(jobAdiv, 'Das Datum ist nicht korrekt.');
                                        break
                                }
                            //   error message end ---------------->
    setErrorFor(
