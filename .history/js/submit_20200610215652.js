...
if((checkFacebook==='yes')||(CheckInstagram==='yes')||(CheckInstagram==='yes')||(CheckInstagram==='yes')){
...
    }
   ...
   const TermsCondi= document.getElementById('TermsCondi'); 
   if (document.getElementById("TermsConditions").value === 'false') {
    //show error
    //add error class
    setErrorFor(TermsCondi, `Please accept the Terms and Conditions.`);
  } else {
    setSuccessFor(TermsCondi);
  } 
console.log(TermsConditions.value);
