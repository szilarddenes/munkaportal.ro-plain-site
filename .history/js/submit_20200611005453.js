...
function checkInputs() {
  ...
  //   FindUS
  const checkFacebook = document.getElementById('checkFacebook').checked;
  const CheckInstagram = document.getElementById('CheckInstagram').checked;
  const CheckWebSearch = document.getElementById('CheckWebSearch').checked;
  const CheckElse = document.getElementById('CheckElse').checked;
  if (
    checkFacebook != 'true' ||
    CheckInstagram != 'true' ||
    CheckWebSearch != 'true' ||
