...
element = document.getElementById("flagHU");

// reset the transition by...
fleghu.addEventListener("click", function(e) {
  e.preventDefault;
  
  // -> removing the class
  fleghu.classList.remove("flagSwing");
  ...
  // Do this instead:
  void fleghu.offsetWidth;
  
  // -> and re-adding the class
  element.classList.add("Flagswing");
}, false);
...
// function flagSwing(a){
//     console.log(' we are in the flagrott.')
//     document.getElementById('tflag').classList.add('flagrotate');
// }
