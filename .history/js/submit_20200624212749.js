...
function checkInputs() {
    ...
    const valassz = ['válassz','alege','choose','wählen'];

 console.log("Job Categoy Select", JobCategoryValue);
 console.log("IF INCLUDES", valassz.includes(JobCategoryValue));
    if (valassz.includes(JobCategoryValue)) {
        //do something
