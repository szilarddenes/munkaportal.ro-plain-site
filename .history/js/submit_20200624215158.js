...
//company name
    ...
    if (companyValue === '') {
        //show error
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        setErrorFor(company, 'Válassz egy típust.');
                                        break
                                    case "ro":
                                        setErrorFor(company, 'Introduce numele companiei/organizației');
                                        break
                                    case "en":
                                        setErrorFor(company, 'Choose a job type.');
                                        break
                                    case "de":
                                        setErrorFor(company, 'Wählen Sie einen Typ.');
                                        break
                                }
                            //   error message end ---------------->
