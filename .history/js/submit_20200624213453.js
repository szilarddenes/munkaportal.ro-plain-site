                ...
                if (notSelected.includes(JobTypeValue)){
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        ...
                                        break
                                    case "ro":
                                        setErrorFor(JobType, 'Alege un tip.');
                                        break
                                    case "en":
    ...
    // job location
                ...
                if (joblocationValue === '') {
                    //show error
                                            ...
                                            switch (nyelv) {
                                                case "hu":
                                                    setErrorFor(joblocation, 'Add meg a munkavégzés helyé');
                                                    break
                                                case "ro":
                                                    setErrorFor(joblocation, 'Alege un tip.');
                                                    break
                                                case "en":
                                                    setErrorFor(joblocation, 'Choose a job type.');
                                                    break
                                                case "de":
                                                    setErrorFor(joblocation, 'Wählen Sie einen Typ.');
                                                    break
                                            }
                                        //   error message end ---------------->
                } else {
