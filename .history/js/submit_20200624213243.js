...
// jobtype
                    if (notSelected.includes(JobTypeValue)){
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        setErrorFor(JobType, 'Válassz egy kategóriát.');
                                        break
                                    case "ro":
                                        setErrorFor(JobType, 'Alege o categorie.');
                                        break
                                    case "en":
                                        setErrorFor(JobType, 'Choose a category.');
                                        break
                                    case "de":
                                        setErrorFor(JobType, 'Wähle eine Kategorie.');
                                        break
                                }
                            //   error message end ---------------->
                } else {
