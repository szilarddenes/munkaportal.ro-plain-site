...
if (checkboxDeadline.checked === false){
  ...
  if ((document.getElementById('JobAnnouncement').value == '') || (document.getElementById('JobAnnouncement').length >2000)) {
    //show error
    //add error class
    //        jobAdiv.classList.add('error')
    setErrorFor(jobAdiv, `Kérjük add meg a hírdetés leírását (max. 2000 karakterben).`);
  } else {
