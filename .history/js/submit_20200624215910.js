                    ...
                    //show error
                                            ...
                                            switch (nyelv) {
                                                case "hu":
                                                    ...
                                                    break
                                                case "ro":
                                                    setErrorFor(joblocation, 'Introduceți locul de desfășurare a activității.');
                                                    break
                                                case "en":
        ...
        //show error
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        ...
                                        break
                                    case "ro":
                                        setErrorFor(phone, 'Numărul de telefon nu este valid.');
                                        break
                                    case "en":
                                        setErrorFor(phone, 'Phone number is invalid.');
                                        break
                                    case "de":
                                        setErrorFor(company, 'Die Telefonnummer ist ungültig.');
                                        break
                                }
                            //   error message end ---------------->
    } else {
    ...
    if (checkboxDeadline.checked === false) {
        if (deadlineUNIX < today || deadlineValue.toString() == '') {
         //show error
                                ...
                                switch (nyelv) {
                                    case "hu":
                                        setErrorFor(deadlineDiv, '`A megadott dátum helytelen.');
                                        break
                                    case "ro":
                                        setErrorFor(deadlineDiv, 'Numărul de telefon nu este valid.');
                                        break
                                    case "en":
                                        setErrorFor(deadlineDiv, 'Phone number is invalid.');
                                        break
                                    case "de":
                                        setErrorFor(deadlineDiv, 'Die Telefonnummer ist ungültig.');
                                        break
                                }
                            //   error message end ---------------->
