...
document.querySelector('.flagHU svg').addEventListener('click', function(evt) {
    ...
    if (fleghu.classList) {
        ...
        fleghu.className += " " + "flagActive";
      }
    
      fleghu.addEventListener(transitionEvent, customFunction);


     
});

function customFunction(evt) {
    fleghu.removeEventListener(transitionEvent, customFunction);
    fleghu.classList.remove('flagActive');
    // Do something when the transition ends
  }

// fleghu.addEventListener('transitionend', removeTransition);
// fleghu.addEventListener('bsTransitionEnd', removeTransition);
