...
document.querySelector('.flagHU svg').addEventListener('click', function(evt) {
    ...
    if (fleg.classList) {
        fleg.classList.add("animate");
      } else {
        fleg.className += " " + "animate";
      }
    
      fleg.addEventListener(transitionEvent, customFunction);
...
function customFunction(event) {
    fleg.removeEventListener(transitionEvent, customFunction);
