...
var translator = new Translator({
  ...
  // var baseElement= document.querySelector(".flags");
  // const flagElement= baseElement.querySelector(".flag");
basElement.addEventListener('click', function (evt) {
    var nyelv = evt.target.id;
    // var nyelv = flagElement.id;
      console.log("id=", evt.target.id);
      console.log("nyelv=",nyelv);
      console.log("bElement=", baseElement);
      console.log("fElement=", flagElement);
