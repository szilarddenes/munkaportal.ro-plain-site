...
// document.querySelector('.flags, .flag svg').addEventListener('click', function (evt) {
...
document.querySelector('.flagHU svg').addEventListener('click', function (evt) {
  ...
  // otherFlags.classList.remove('flagActive');
  ...
  otherFlags.forEach(function(entry){
    ...
    if (theFlag.classList.contains('flagActive').length > 0) {
      theFlag.classList.remove('flagActive');
      console.log('classlist THFLAG', theFlag.classList);
    }
  });
...
document.querySelector('.flagRO svg').addEventListener('click', function (evt) {
  ...
  var otherFlags = ["hu", "en","de"];
  otherFlags.forEach(function(entry){
    var theFlag = document.getElementById (entry);
    console.log("x = ",theFlag);
    if (theFlag.classList.contains('flagActive')) {
      theFlag.classList.remove('flagActive');
    }
  });
