...
function swingLinks() {
    const navlinkkk = document.getElementById('#flags').childNodes;
    for(var i=0; i<nodes.length; i++) {
         if (nodes[i].nodeName.toLowerCase() == 'div') {
        nodes[i].classList.add('flagSwing');
         }
    }
}
...
//   navlinkkk.classList.add('flagSwing');
  //animate__shakeX
});
...
function swingLinks() {
    const flagDivs = document.getElementById('#flags').childNodes;
    for(var i=0; i<nodes.length; i++) {
         if (nodes[i].nodeName.toLowerCase() == 'div') {
        nodes[i].classList.add('flagSwing');
         }
...
function removeTransition(evt) {
  ...
  navlinkkk.classList.remove('flagSwing');
