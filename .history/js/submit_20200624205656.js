...
function checkInputs() {
    ...
    // var valasztott = sel.options[1].text;
    // display value and text property values
// console.log("selected value ===", opt.value );
// console.log("selected text ===", opt.text );
// console.log( opt.text );
    ...
    // jobcategory
    if ((JobCategoryValue === "válassz") ||(JobCategoryValue === "choose") ||(JobCategoryValue === "alege")||(JobCategoryValue === "alege")) {
        //show error
        //add error class
