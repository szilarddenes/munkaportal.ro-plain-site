...
document.querySelector('.flagHU svg').addEventListener('click', function(evt) {
    ...
    if (fle.classList) {
        fle.classList.add("animate");
      } else {
        fle.className += " " + "animate";
      }
    
      fle.addEventListener(transitionEvent, customFunction);
...
function customFunction(event) {
    fle.removeEventListener(transitionEvent, customFunction);
